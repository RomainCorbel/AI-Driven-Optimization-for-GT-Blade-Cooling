...
if not DEBUG:
    ...
    run = wandb.init(
        ...
        config={
            ...
            "lr_min": LR_MIN, "scheduler": "cosine_warm_restarts", "T_0": T_0, "T_mult": N_mult,
...
scheduler   = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(opt_model, T_0=T_0, T_mult=N_mult, eta_min=LR_MIN)
